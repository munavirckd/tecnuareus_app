...
import 'package:technaureus_application/dahborad/dashboard.dart';
...
import 'package:technaureus_application/products/product_screen.dart';
...
// Register adapters for your Hive models
  ...
  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (context) => AppNavigationState()),
